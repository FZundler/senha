              ...
              <div className="absolute left-0 top-0 h-full w-1/3 bg-[url('/homem.png')] bg-no-repeat bg-cover opacity-40 translate-y-[133px] translate-x-[70px]"></div>
                ...
                <div className="max-w-screen-xl mx-auto flex items-center justify-between">
                    <ul className="flex justify-center space-x-8 py-4">
                        <li>
                            <Link href="/" className="no-underline text-gray-700 hover:text-blue-700 font-bold">
                                Principal
                            </Link>
                        </li>
                        <li>
                            <Link href="/about" className="no-underline text-gray-700 hover:text-blue-700 font-bold">
                                Suporte
                            </Link>
                        </li>
                        <li>
                            <Link href="/pages" className="no-underline text-gray-700 hover:text-blue-700 font-bold">
                                Serviços
                            </Link>
                        </li>
=======
